...
<body>
	<div class="header">
		<h2>Student - View - Lecture Notes</h2>
	</div>
	<div class="content">
		...
		<br>	
		<br>
			<form method="post" action="lecture_notes1.php">
		
		<?php echo display_error(); ?>
		<link rel="stylesheet" type="text/css" href="form.css">
			
			<p>
			<br>View Lecture Notes: 
			</p>
			<br>
			<div class="input-group">
			<button class="btnn btn-success" onclick=" window.open('https://drive.google.com/drive/folders/1xjV6rFPMSPMmajbEzeBJIztEshcYC_jS?usp=sharing','_blank')"> Go >>> </button>
		</div>
		<br>
