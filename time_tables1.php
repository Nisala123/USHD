...
<body>
	<div class="header">
		<h2>Student - View - Time Tables</h2>
	</div>
	<div class="content">
		...
		<br>	
		<br>
			<form method="post" action="time_tables1.php">
		...
		<link rel="stylesheet" type="text/css" href="form.css">
			...
			<button class="btnn btn-success" onclick=" window.open('https://drive.google.com/open?id=1NQHHAYLz6t0Gvq4xZVnwynkXfAUPYWUx','_blank')"> Go >>> </button>
		</div>
		<br>
