...
<body>
	<div class="header">
		<h2>Student - View - Exam Details</h2>
	</div>
	<div class="content">
		...
		<br>	
		<br>
			<form method="post" action="exam_details1.php">
		
		<?php echo display_error(); ?>
		<link rel="stylesheet" type="text/css" href="form.css">
			
			<p>
			<br>View Exam Details: 
			</p>
			<br>
			<div class="input-group">
			<button class="btnn btn-success" onclick=" window.open('https://drive.google.com/open?id=1RafDz2VzeXTw7DR4B8GAM7RUIGns-aA4','_blank')"> Go >>> </button>
		</div>
		<br>
