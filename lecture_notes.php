...
<body>
	<div class="header">
		<h2>Lecturer - Uploads - Lecture Notes</h2>
	</div>
	<div class="content">
		...
		<link rel="stylesheet" type="text/css" href="form.css">
			...
			<p>
			<br>Upload Lecture Notes: 
			</p>
			<br>
			<div class="input-group">
			<button class="btnn btn-success" onclick=" window.open('https://drive.google.com/drive/folders/1-hyDwYCSdC9-NFACTtx9WPgWXoyN9WQo','_blank')"> Go >>> </button>
		</div>
		<br>
