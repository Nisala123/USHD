...
<body>
	<div class="header">
		<h2>Lecturer - Uploads - Exam Details</h2>
	</div>
	<div class="content">
		...
		<link rel="stylesheet" type="text/css" href="form.css">
			...
			<p>
			<br>Upload Exam Details: 
			</p>
			<br>
			<div class="input-group">
			<button class="btnn btn-success" onclick=" window.open('https://drive.google.com/drive/folders/1XVNS0bHAMos9gjEizjSMyM5XaOPMCazA','_blank')"> Go >>> </button>
		</div>
		<br>
