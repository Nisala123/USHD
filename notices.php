...
<body>
	<div class="header">
		<h2>Lecturer - Uploads - Notices</h2>
	</div>
	<div class="content">
		...
		<link rel="stylesheet" type="text/css" href="form.css">
			...
			<button class="btnn btn-success" onclick=" window.open('https://drive.google.com/drive/folders/1rc8NvnHVyd6myAb5t393UDT108wAi2Wy','_blank')"> Go >>> </button>
		</div>
		<br>
