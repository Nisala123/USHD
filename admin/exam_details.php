...
<body>
	<div class="header">
		<h2>Admin - Uploads - Exam Details</h2>
	</div>
	<div class="content">
		...
		<br>	
		<br>
			<form method="post" action="exam_details.php">
		...
		<link rel="stylesheet" type="text/css" href="../form.css">
			...
			<p>
			<br>Upload Exam Details: <button class="btnn btn-success" onclick=" window.open('https://drive.google.com/drive/folders/1RafDz2VzeXTw7DR4B8GAM7RUIGns-aA4','_blank')"> Click Here </button>
			
			</p>
			<br>
			<br>
			<div class="input-group">
			<button type="submit" class="btnn" name="exam_btn"> + Add Exam Details</button>
		</div>
